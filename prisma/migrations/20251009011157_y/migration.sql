-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'MODERATOR', 'SELLER', 'CUSTOMER');
...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('RAZORPAY', 'STRIPE', 'CASH_ON_DELIVERY', 'MANUAL');
...
-- CreateIndex
CREATE INDEX "ProductFeature_productId_order_idx" ON "ProductFeature"("productId", "order");
